...
if (strlen($_SESSION['efileid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    $hid = $_SESSION['efileid'];
    $cpassword = md5($_POST['currentpassword']);
    $newpassword = md5($_POST['newpassword']);
    $sql = "SELECT userid FROM users WHERE userid=:hid and password=:cpassword";
    ...
    if ($query->rowCount() > 0) {
      $con = "update users set password=:newpassword where userid=:hid";
      $chngpwd1 = $dbh->prepare($con);
      $chngpwd1->bindParam(':hid', $hid, PDO::PARAM_STR);
  ...
  <head>
    ...
    <title>E-Filing System || Change Password</title>
